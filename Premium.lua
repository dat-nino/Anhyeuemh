...
local Window = Fluent:CreateWindow({
    Title = "Maraki Hub Mob-BloxFruits [ Premium ]", -- skip unban
...
local Tabs = {
    info = Window:AddTab({ Title = "Info", Icon = "wifi" }),
