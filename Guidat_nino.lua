...
if not game.CoreGui:FindFirstChild("ThunderScreen") then
    ...
    TestLabelEN.Text = "English: Script Not Work [ to fix all mob farm ]"
    ...
    TestLabelVN.Text = "Việt: Script không hoạt động [ để sửa tất cả trang trại mob"
    ...
    ThunderToggleUI.MouseButton1Click:Connect(function()
        setclipboard("https://discord.gg/VsskK3G4")
    end)
end
